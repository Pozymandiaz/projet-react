...
const NavigationStack = () => {
    return (
        <Stack.Navigator screenOptions={{
          ...
          <Stack.Screen component={GestionUser} name="GestionUser" options={{title: "GestionUser"}}/>
          <Stack.Screen component={FormCreateUser} name="CreateUser" options={{title: "CreateUser"}}/>
          <Stack.Screen component={FormUpdateUser} name="UpdateUser" options={{title: "UpdateUser"}}/>
